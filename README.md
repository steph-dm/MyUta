...
Karaoke score tracker for DAM and JOYSOUND machines. Log each session with scores, tag what went wrong (pitch, rhythm, timing, etc.), and track which songs you're improving on. Available in English / Japanese.
