    ...
    return (
        <TableRow className={isSelected ? "bg-muted/50" : ""}>
            ...
            <TableCell className="font-medium truncate">
                <Link to={`/artists/${review.song.artist.id}`} className="hover:underline transition-colors">
                    {review.song.artist.name}
                </Link>
            </TableCell>
            <TableCell className="font-medium truncate">
                <Link to={`/songs/${review.song.id}`} className="hover:underline transition-colors">
                    {review.song.title}
                </Link>
            </TableCell>
            <TableCell>
