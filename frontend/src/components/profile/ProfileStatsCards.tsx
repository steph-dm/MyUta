      ...
      <Card>
        ...
        <CardContent className="pt-0">
          <div className="flex gap-2 text-xs text-muted-foreground">
            <Badge
              variant="secondary"
              className={`${getMachineBadgeColor("DAM")} text-xs`}
            >
              DAM {damReviews.length}
            </Badge>
            <Badge
              variant="secondary"
              className={`${getMachineBadgeColor("JOYSOUND")} text-xs`}
            >
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardDescription className="flex items-center gap-2">
              ...
              <Badge
                variant="secondary"
                className={`${getMachineBadgeColor("DAM")} text-xs px-2 py-0`}
              >
                DAM
              </Badge>
            </CardDescription>
            <CardTitle className="text-2xl">
              {avgScore(damReviews, t("stats.noData"))}
            </CardTitle>
          </CardHeader>
        </Card>
      )}
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardDescription className="flex items-center gap-2">
              ...
              <Badge
                variant="secondary"
                className={`${getMachineBadgeColor("JOYSOUND")} text-xs px-2 py-0`}
              >
                JOYSOUND
              </Badge>
            </CardDescription>
            <CardTitle className="text-2xl">
              {avgScore(joysoundReviews, t("stats.noData"))}
            </CardTitle>
          </CardHeader>
        </Card>
      )}
