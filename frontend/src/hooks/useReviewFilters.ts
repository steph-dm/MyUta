...
export interface ReviewFiltersActions {
  ...
  setScoreSortDirection: React.Dispatch<
    React.SetStateAction<"asc" | "desc" | null>
  >;
...
export type UseReviewFiltersReturn = ReviewFiltersState &
  ReviewFiltersActions &
  ReviewFiltersComputed;
...
export const useReviewFilters = (
  ...
  const [scoreSortDirection, setScoreSortDirection] = useState<
    "asc" | "desc" | null
  >(null);
